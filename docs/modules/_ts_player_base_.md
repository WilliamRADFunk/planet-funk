[planet-funk](../README.md) > ["ts/player/base"](../modules/_ts_player_base_.md)
...
*Defined in [ts/player/base.ts:16](https://github.com/WilliamRADFunk/planet-funk/blob/e9ae4fe/src/ts/player/base.ts#L16)*
